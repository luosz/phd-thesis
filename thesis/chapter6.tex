...
Gradient descent is employed in our optimizer. In terms of gradient estimations, we have experimented with two methods. First, we have tried to estimate the gradient with a backward difference divided by a small step.
