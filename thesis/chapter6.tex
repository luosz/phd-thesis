...
\subcaption{}
\end{minipage}
\caption{(a) Figure~\ref{fig:hurricane_hsba} (b) in a 3D perspective view; (b) The hurricane at frame 40 rendered with both saturation and brightness representing the precipitation. Hue is cyan, a=10 and b=10; (c) A 3D perspective view of (b)}
