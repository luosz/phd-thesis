...
\begin{figure}
	...
	\caption{The two methods for estimating search directions are applied to transfer function optimization on the nuclon data set (left) and a tooth data set(right).
		Method 1 converges (the objective function falls below 0.01) at the 10th step and method 2 converges at the 9th step on the nucleon data set with a naive transfer function of equal opacity for each feature.
		The two methods both converge at the 47th step on the tooth data set, also with a native transfer function of equal opacity for each feature.}
...
\subsubsection{Comparion of Line Search and Parallel Line Search}
