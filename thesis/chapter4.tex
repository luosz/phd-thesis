...
Equal weights of appearance attributes are used in our implementation, however, more detailed perceptual studies may determine more ideal weights.
...
9 volume data sets were used to produce images for the experiment and the images of 2 data sets (CThead and lobster) were only used in the training session at the beginning of the experiment.
The results of 7 volume data sets were analyzed. These data sets are engine block, foot, MRbrain, nucleon, vismale, tooth, vismale and horse embryo \cite{website:Roettger_volume_2013} \cite{website:Voreen_datasets_2013}.
