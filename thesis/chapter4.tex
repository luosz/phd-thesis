...
Before discussion of the proposed methods, we first define a feature $ F $ as a subset of voxels in the volume $ V $, i.e. 
\[ F\subseteq V 
\addtag \]

In the case of intensity-based 1D transfer functions, a feature can also be defined using an intensity interval, i.e.
\[ F=\{ a \leq i<b | i \in V \} 
\addtag \]
where $ [a,b) $ is the intensity interval that contains all the voxels of feature $F$.
