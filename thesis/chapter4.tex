...
On the other hand, the feature visibility is not aware of the saturation change and is the same as in Figure~\ref{fig:tooth_naive_optimized_linesearch} (b).
...
\begin{figure}
	...
	\begin{minipage}{.24\textwidth}
		...
		\subcaption{}
	\end{minipage}
	\caption{(a) The saturation of the red feature is reduced; (b) The visibility-weighted saliency of (a): the red feature has lower VWS and the yellow has higher VWS.}
