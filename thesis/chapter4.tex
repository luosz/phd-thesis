...
Feature visibility measures the contribution of each feature to the volume rendered image and saliency fields measure the visual saliency of each voxel in its local neighborhood.
...
Correa and Ma \cite{correa_visibility_2011} introduced visibility histogram, which describes the accumulated visibility of each intensity range in the transfer function.
