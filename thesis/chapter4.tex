...
\begin{figure}
	...
	\begin{minipage}{.24\textwidth}
		...
		\subcaption{}
	\end{minipage}
	\caption{(a) The saturation of the red feature is reduced; (b) The feature visibility is the same as Figure~\ref{fig:tooth_naive_optimized_linesearch} (b); (c) The visibility-weighted saliency of (a): the red feature has lower VWS and the yellow has higher VWS.}
