...
In addition, as shown in Figure~\ref{fig:mos_vs_metric}, we analyze the mean opinion scores versus the visual saliency metric for each feature of the data sets separately.
