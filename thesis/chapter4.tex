...
Because the rating scales may not be linear, normally distributed or consistently applied across participants and data sets \cite{cunningham_experimental_2011}, this structure of the results may violate many assumptions of standard statistical tests.

As shown in Figure~\ref{fig:mos_vs_metric}, we analyze the mean opinion scores versus the visual saliency metric for each feature of the data sets separately.
