...
Data value activity has been used in the classiﬁcation of
time-varying data
...
The time activity curve (TAC) \cite{fang_visualization_2007} uses a vector representation of the values each voxel ordered by time, representing the values of the voxel over time. It is a common method to represent the change of time-varying data over time.

\cite{woodring_multiscale_2009}
