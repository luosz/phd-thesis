...
\cite{svakhine_illustration-inspired_2009}
\cite{van_pelt_illustrative_2010}
...
The transfer function concept and design process is still an active research topic as it is generally considered that transfer function creation needs to be simplified and at the same time extended with more functionality in order to realize the full potential of volume rendering. The medical field in particular requires more sophisticated transfer function solutions to express a variety of domain specific knowledge in proper terms.

Transfer function creation needs to be simplified and the functionality needs to be extended i order to realize the full potential of volume rendering.
Transfer function design is still an active research topic.
...
\cite{kindlmann_semi-automatic_1998}
