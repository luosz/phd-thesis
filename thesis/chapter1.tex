...
The main goal of our research is to investigate the optimization of visualization parameters (in particular transfer functions) with information derived from volume data and feedback mechanisms
% (e.g. visibility and visual saliency in resulting images) 
from the volume rendering process.
...
Another motivation is that in current volume rendering systems, appropriate transfer functions are often obtained by trial-and-error.
We hypothesize that combining automated optimization techniques with feedback mechanisms such as visibility and visual saliency can provide an intuitive means for obtaining clear visualization of features of interest in volume data
