...
\renewcommand{\thesismonth}{November}                  %% Your month of graduation.
...
Multivariate volume data are volume data that contains multiple variables in each voxel, e.g. a data set containing variables from multiple modalities such as CT, MRI, and PET.
