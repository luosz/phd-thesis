...
Volume visualization is a powerful technique for depicting complicated 3D structures in volume data sets.
...
In practice, transfer functions are often specified in a trial and error manner with careful observation of changes in the resulting image.
