...
In addition, although the two line search methods use the same numbers of steps, the parallel line search only took about half the time of the sequential line search.
