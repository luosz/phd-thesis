\chapter{Visibility-Weighted Saliency for Volume Visualization}
...
In terms of implementation, the computation of visibility fields can be performed in real-time on GPU.
...
and $ O $ is a field of appearance attributes of every voxels in the volume and $ O(j) $ is the appearance attribute of voxel $ j $.
...
The visibility field indicates how much each voxel contributes to the final image and the saliency field represents how much each voxel stands out from its surroundings. It would be desirable to have an indicator that represents both the contribution and conspicuousness of the voxels. Therefore we propose a visibility-weighted saliency field, by weighting the saliency of voxels by their visibility, given the volume is rendered with a specific transfer function from a specific viewpoint.
...
\centering
\begin{minipage}{.15\textwidth}
\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_feature1_2.png}
\end{minipage}~
\begin{minipage}{.15\textwidth}
\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_feature2_2.png}
\end{minipage}~
\begin{minipage}{.15\textwidth}
\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_feature3_2.png}
\end{minipage}
...
\centering
\begin{minipage}{.2\textwidth}
\includegraphics[width=1\linewidth]{images/tooth_visibility_chart_2.png}
\end{minipage}~
%\begin{minipage}{.2\textwidth}
%\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_brightness_chart_2.png}
%\end{minipage}
%\begin{minipage}{.2\textwidth}
%\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_saturation_chart_2.png}
%\end{minipage}~
\begin{minipage}{.2\textwidth}
\includegraphics[width=1\linewidth]{images/tooth_visibility_saliency_weighted_chart_2.png}
\end{minipage}
