...
\begin{figure}
	...
	\end{minipage}
	\caption{The two methods for estimating descent directions are applied to transfer function optimization on the nucleon data set (left) and a tooth data set(right).
		Method 1 converges (the objective function falls below 0.01) at the 10th step and method 2 converges at the 9th step on the nucleon data set with a naive transfer function (assigning equal opacity to each feature).
...
\begin{figure}
	...
	\end{minipage}
	\caption{After optimization to target \{0.34, 0.33, 0.33\}, all the 3 features are visible and the green feature inside is particularly emphasized.}
...
\end{tabular}
\caption[Table caption text]{Performance of the 3 optimization approaches on the nucleon data set ($ 41 \times 41 \times 41 $)}
